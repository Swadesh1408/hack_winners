 ...
 */
public class YourProducts extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            List<ProductDetails> products=ProductModel.getProductsByCompanyId(SellerDetails.getCompanyId());
            if(products.isEmpty()){
                RequestDispatcher rd=request.getRequestDispatcher("userPage.jsp");
                rd.forward(request, response);
            }
            sc.setAttribute("productList", products);
